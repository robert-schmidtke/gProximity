...
std::ostream& operator<<(std::ostream &s, Field &value)
{
	...
	case fieldTypeSFBool		:
		return s << ((SFBool &)value);
	case fieldTypeSFColor		:
		return s << ((SFColor &)value);
	case fieldTypeSFFloat		:
		return s << ((SFFloat &)value);
	case fieldTypeSFInt32		:
		return s << ((SFInt32 &)value);
	case fieldTypeSFRotation	:
		return s << ((SFRotation &)value);
	case fieldTypeSFString		:
		return s << ((SFString &)value);
	case fieldTypeSFTime		:
		return s << ((SFTime &)value);
	case fieldTypeSFVec2f		:
		return s << ((SFVec2f &)value);
	case fieldTypeSFVec3f		:
		return s << ((SFVec3f &)value);
...
//	  	case fieldTypeSFNode		: return s << (SFNode *)value;
	case fieldTypeMFColor		:
		return s << (MFColor *)value;
	case fieldTypeMFFloat		:
		return s << (MFFloat *)value;
	case fieldTypeMFInt32		:
		return s << (MFInt32 *)value;
	case fieldTypeMFRotation	:
		return s << (MFRotation *)value;
	case fieldTypeMFString		:
		return s << (MFString *)value;
	case fieldTypeMFTime		:
		return s << (MFTime *)value;
	case fieldTypeMFVec2f		:
		return s << (MFVec2f *)value;
	case fieldTypeMFVec3f		:
		return s << (MFVec3f *)value;
//	  	case fieldTypeMFNode		: return s << (MFNode *)value;
	}
	return s;
}
