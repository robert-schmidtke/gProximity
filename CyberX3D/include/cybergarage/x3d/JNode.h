...
namespace CyberX3D
{
	...
	public:
		...
		virtual		jclass		getNodeObjectClassID()
		{
			return mNodeObjectClassID;
		}
		...
		virtual		jmethodID	getInitMethodID()
		{
			return mInitMethodID;
		}
		virtual		jmethodID	getSetNameMethodID()
		{
			return mSetNameMethodID;
		}
		
		virtual		jmethodID	getAddEventInMethodID()
		{
			return mAddEventInMethodID;
		}
		virtual		jmethodID	getAddEventOutMethodID()
		{
			return mAddEventOutMethodID;
		}
		virtual		jmethodID	getAddFieldMethodID()
		{
			return mAddFieldMethodID;
		}
		virtual		jmethodID	getAddExposedFieldMethodID()
		{
			return mAddExposedFieldMethodID;
		}
		
		virtual		jmethodID	getGetEventInMethodID()
		{
			return mGetEventInMethodID;
		}
		virtual		jmethodID	getGetEventOutMethodID()
		{
			return mGetEventOutMethodID;
		}
		virtual		jmethodID	getGetFieldMethodID()
		{
			return mGetFieldMethodID;
		}
		virtual		jmethodID	getGetExposedFieldMethodID()
		{
			return mGetExposedFieldMethodID;
		}
		
		virtual		jmethodID	getGetNEventInMethodID()
		{
			return mGetNEventInMethodID;
		}
		virtual		jmethodID	getGetNEventOutMethodID()
		{
			return mGetNEventOutMethodID;
		}
		virtual		jmethodID	getGetNFieldsMethodID()
		{
			return mGetNFieldsMethodID;
		}
		virtual		jmethodID	getGetNExposedFieldsMethodID()
		{
			return mGetNExposedFieldsMethodID;
		}
		...
		void		setNodeObject(jobject object)
		{
			mNodeObject = object;
		}
		jobject		getNodeObject()
		{
			return mNodeObject;
		}
